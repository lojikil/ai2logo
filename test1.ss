; Phantom/test1: a more realistic Logo system
; Should convert to using the let macros defined in the
; standard prelude, so that I can use this in systems other than
; Digamma :D
